...
def train(
    ...
    keys_list = ['train', 'val']
    results_dict = {x: [] for x in keys_list}

    # # zero out the gradients to start
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            results_dict['train'].append(train_loss_epoch / len(train_loader))
            ...
            if val_loader is not None:
                ...
                results_dict['val'].append(val_loss_epoch / len(val_loader))
...
def plot_model_guesses(
    dataloader: DataLoader, model: nn.Module, title: Optional[str] = None, suffix: Optional[str] = None
):
    """Helper function!
    ...
    with torch.no_grad():
        ...
        plt.ylabel("x1")
        plt.legend()
        plt.savefig('/Users/hlukas/Google Drive/Grad School/2021-2022/Autumn/CSE 546/Assignments/HW3/A4c_{}.png'.format(suffix))
        plt.close()
