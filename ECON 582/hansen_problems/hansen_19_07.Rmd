...
This will be fairly similar to the previous calculation, except that we need to cluster by school. The nice thing is that instead of leaving out an observation, we leave out a cluster, so there should be fewer computations.
